...
/**
 * Classe qui gère le controleur de la fenetre principale et la lance
 */
...
public class DailyBankMainFrame extends Application {
	...
	/** Redéfinition de la fonction qui lance l'application
	 * @param primaryStage : la fenetre qui sera la fenetre principale
	 */
	@Override
