...
Une fenêtre s'affiche où l'utilisateur doit rentrer le capital emprunté, durée de l'emprunt en années, le taux annuel en pourcentage, la périodicité (mensuel ou annuel) et la mensualité d'assurance (en pourcentage). Si l'utilisateur ne souhaite pas utiliser d'assurance, il faut laisser le champ mensualité d'assurance à 0%.
L'utilisateur peut ensuite valider l'emprunt. 

image:img/.png[]

Pour que l'opération soit validée, tous les champs doivent être remplis et positifs.
